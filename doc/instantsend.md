...
This mechanism has been integrated into Bitcore-Node-AnonPay which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nvolprotocol/insight-api-anonpay#web-socket-api](https://github.com/nvolprotocol/insight-api-anonpay#web-socket-api)
* API: [https://github.com/nvolprotocol/insight-api-anonpay#instantsend-transactions](https://github.com/nvolprotocol/insight-api-anonpay#instantsend-transactions)
