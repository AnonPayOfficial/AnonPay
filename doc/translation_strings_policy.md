...
This document provides guidelines for internationalization of the AnonPay Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `anonpay_en.ts` remains unchanged.
