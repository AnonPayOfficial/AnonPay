...
* anonpay.conf: contains configuration settings for anonpayd or anonpay-qt
* anonpayd.pid: stores the process id of anonpayd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by anonpayd or anonpay-qt
