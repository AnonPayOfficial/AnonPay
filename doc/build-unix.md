UNIX BUILD NOTES
====================
Some notes on how to build AnonPay Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Base build dependencies
-----------------------
Building the dependencies and AnonPay Core requires some essential build tools and libraries to be installed before.
...
Security
--------
To help make your AnonPay installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, AnonPay Core should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, AnonPay Core may be compiled in
