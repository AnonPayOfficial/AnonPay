Contributing to AnonPay Core
============================

The AnonPay Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nvolprotocol/anonpay/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the AnonPay Core project (and related
projects such as libsecp256k1), and is not to be confused with overall AnonPay
Network Protocol consensus changes.

Whether a pull request is merged into AnonPay Core rests with the project merge
...
Patches that change AnonPay consensus rules are considerably more ianonpayd than
...
Where a patch set proposes to change the AnonPay consensus, it must have been
...
The review process is normally fairly responsive on the AnonPay Core repository, however
...
The project leader is the release manager for each AnonPay Core release.
