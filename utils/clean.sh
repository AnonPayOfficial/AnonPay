...
rm -f src/config/anonpay-config.h
...
rm -rf test_bitcoin.coverage/ anonpay-gtest.coverage/ total.coverage/
...
clean_exe src/anonpay-cli
clean_exe src/anonpayd
clean_exe src/anonpay-gtest
clean_exe src/anonpay-tx
clean_exe src/test/test_anonpay
clean_exe src/test/test_anonpay_fuzzy
...
clean_dep . src/config/anonpay-config.h.in
