...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord *wtx, bool tooltip) const
{
    ...
    if (tooltip) {
        ...
        watchAddress = wtx->ianonpaysWatchAddress ? QString(" (") + tr("watch-only") + QString(")") : "";
    }
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::EditRole:
        ...
        case Type:
            return formatTxType(rec);
        case Watchonly:
            return (rec->ianonpaysWatchAddress ? 1 : 0);
        case ToAddress:
    ...
    case WatchonlyRole:
        return rec->ianonpaysWatchAddress;
...
QVariant TransactionTableModel::headerData(int section, Qt::Orientation orientation, int role) const
{
    if(orientation == Qt::Horizontal)
    {
        ...
        } else if (role == Qt::ToolTipRole)
        {
            ...
            case Watchonly:
                return tr("Whether or not a watch-only address is ianonpayd in this transaction.");
            case ToAddress:
