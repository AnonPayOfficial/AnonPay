...
/** Utility functions used by the AnonPay Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "anonpay:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load anonpay specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a anonpay specific theme is activated (light/dark).*/
