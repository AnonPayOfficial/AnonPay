...
//
//     src/qt/test/test_anonpay-qt -platform xcb      # Linux
//     src/qt/test/test_anonpay-qt -platform windows  # Windows
//     src/qt/test/test_anonpay-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: anonpay:")) != -1);
