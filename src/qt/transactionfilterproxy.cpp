...
bool TransactionFilterProxy::filterAcceptsRow(int sourceRow, const QModelIndex &sourceParent) const
{
    ...
    bool ianonpaysWatchAddress = index.data(TransactionTableModel::WatchonlyRole).toBool();
    if (ianonpaysWatchAddress && watchOnlyFilter == WatchOnlyFilter_No)
        return false;
    if (!ianonpaysWatchAddress && watchOnlyFilter == WatchOnlyFilter_Yes)
        return false;
