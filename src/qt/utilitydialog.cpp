    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  anonpay-qt [command-line options]                     \n";
...
All the AnonPay in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 ANP, 0.01 ANP, 0.1 ANP, 1 ANP and 10 ANP -- sort of like the paper money you use every day.</li> \
