...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a AnonPay address"));
    sendCoinsMenuAction->setToolTip(sendCoinsMenuAction->statusTip());

    coinJoinCoinsMenuAction = new QAction("&CoinJoin", this);
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a AnonPay address").arg("CoinJoin"));
    coinJoinCoinsMenuAction->setToolTip(coinJoinCoinsMenuAction->statusTip());

    receiveCoinsMenuAction = new QAction(tr("&Receive"), this);
    receiveCoinsMenuAction->setStatusTip(tr("Request payments (generates QR codes and anonpay: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about AnonPay Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AnonPay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AnonPay addresses"));
    ...
    openAction->setStatusTip(tr("Open a anonpay: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/configure"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible AnonPay command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (fNetworkActive) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AnonPay network", "", count));
    } else {
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the anonpay logo
...
{
    QString strTitle = tr("AnonPay Core"); // default title
