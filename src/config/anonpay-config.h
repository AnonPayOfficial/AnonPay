/* src/config/anonpay-config.h.  Generated from anonpay-config.h.in by configure.  */
/* src/config/anonpay-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ANPVE_CONFIG_H

#define ANPVE_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The AnonPay Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "AnonPay Core"
...
#define PACKAGE_BUGREPORT "https://github.com/nvolprotocol/anonpay/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "AnonPay Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "AnonPay Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "anonpaycore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://anonpay.tech/"
