...
//! Interface for the src/evo part of a anonpay node (anonpayd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a anonpay node (anonpayd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a anonpay node (anonpayd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a anonpay node (anonpayd process).
class Node
{
public:
    virtual ~Node() {}
