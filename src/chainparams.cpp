...
// Copyright (c) 2020-2022 The Gainprox developers
...
{
    const char* pszTimestamp = "Privacy Focused Encryption";
    const CScript genesisOutputScript = CScript() << ParseHex("0492ffd9accb82b2a1c7ec958e65dfb65ab31cab0f81a60fd8c6c6adda8df45b8c75019896437f79411d702ffe2b23e30142f4a5c7ae36a1bbbe207ef3aea7790a") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x000001115d9cde3a542c483770d7dbfc5122e2e89ec84b6e41fc383b9fe6f989"); // 0
        ...
        genesis = CreateGenesisBlock(1719413823, 622394, 0x1e0ffff0, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7ea14c4e3cd1b9a84626a074a5a1dd9ecf1688cab1c85ed3d00ca9a17a08f2a9"));
        assert(genesis.hashMerkleRoot == uint256S("0x8dde12891aa62b499f8e6906270f772bf4a54f0a98e23955d7678817879604ab"));
        vSeeds.emplace_back("node1.anonpay.net");
        vSeeds.emplace_back("node2.anonpay.net");
	    vSeeds.emplace_back("node3.anonpay.net");
	    vSeeds.emplace_back("node4.anonpay.net");
		vSeeds.emplace_back("node5.anonpay.net");
        ...
        std::vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 0}  };// founder/dev fee 
        ...
        vSporkAddresses = {"AKeYArfYiqyASUxtF98jvQCdNNzhW5sk4E"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1719413823,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gainprox: 1 day
        consensus.nPowTargetSpacing = 60; // Gainprox: 1 minutes
        ...
        //FindMainNetGenesisBlock(1684675316,  0x20001fff, "test");
        genesis = CreateGenesisBlock(1684675316, 3724, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x59bdb518e6ea56488a54b12378d3d0e46775761df9a7d24f8f25ede3be667a87"));
        assert(genesis.hashMerkleRoot == uint256S("0x8d7ae224b79f6f6cf8e2bb8fa5bf592208afec12348cb7219c3fefeb3a356802"));
        ...
        vSeeds.emplace_back("tes.gainprox.com");
        //vSeeds.emplace_back("tnet1.gainprox.com", true);
        //vSeeds.emplace_back("tnet2.gainprox.com", true);

        // Testnet Gainprox addresses start with 't'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Testnet Gainprox script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Gainprox BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Gainprox BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Gainprox BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        consensus.nFounderPayment = FounderPayment(rewardStructures, 200, "grhjACzPtVAN2wydgDbn9Jq1agREu6rH1e");
        ...
        vSporkAddresses = {"Ggjkd8bSveaBgYFV59QdvQ2KXc2nFPcTS7"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gainprox: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Gainprox: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("gainproxevo.org",  "devnet-seed.gainproxevo.org"));

        // Testnet Gainprox addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Gainprox addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Gainprox script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Gainprox BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Gainprox BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Gainprox BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
