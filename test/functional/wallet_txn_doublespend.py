...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 ANPVE:
        ...
        # First: use raw transaction API to send 12400 ANPVE to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 500ANPVE for another
        ...
        # Node0's total balance should be starting balance, plus 1000ANPVE for
