...
class LLMQCoinbaseCommitmentsTest(AnonPayTestFramework):
    def set_test_params(self):
        self.set_anonpay_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as AnonPayTestFramework doesn't support this atm)
