...
"""Verify that starting anonpayd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start anonpayd with -h for help text")
        ...
        self.log.info("Start anonpayd with -version for version information")
