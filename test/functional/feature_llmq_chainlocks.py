...
from test_framework.test_framework import AnonPayTestFramework
...
class LLMQChainLocksTest(AnonPayTestFramework):
    def set_test_params(self):
        self.set_anonpay_test_params(6, 5, fast_dip3_enforcement=True)
